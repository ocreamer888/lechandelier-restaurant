  ...
  return (
    <section className="relative min-h-screen">
      <div className="grid items-start justify-start h-auto grid-cols-1 gap-4 p-2 md:p-4 lg:grid-cols-[1fr_600px]">
        ...
        <Link href={`/${locale}/menu`} className="relative h-[50vh] lg:h-[90vh] max-h-[700px] mb-8 lg:mb-0 rounded-3xl overflow-hidden group block border border-white/10" id="menu">
          <Image
          ...
          <div className="relative flex flex-col w-full h-full items-center justify-center lg:items-start lg:justify-end p-6">
