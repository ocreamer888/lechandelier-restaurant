      ...
      <div className="grid h-auto min-h-screen grid-cols-1 gap-4 p-2 md:p-4 lg:grid-cols-[1fr_600px]">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="relative h-[28vh] min-h-[180px] lg:h-auto">
            <Card href="#menu" label="Corporate" src="/restaurante-le-chandelier-2.webp" alt="Explore our menu" />
          </div>
          <div className="relative h-[24vh] min-h-[160px] lg:h-auto">
            <Card href="#reservation" label="Celebrations" src="/filler-image-2.png" alt="Book a table" />
          </div>
          <div className="relative h-[24vh] min-h-[160px] lg:h-auto">
            <Card href="#about" label="Private Parties" src="/restaurante-le-chandelier-2.webp" alt="About our restaurant" />
          </div>
          <div className="relative h-[24vh] min-h-[160px] lg:h-auto">
            <Card href="#about" label="Special Occasions" src="/restaurante-le-chandelier-2.webp" alt="About our restaurant" />
          </div>
        </div>
      </div>
    </section>
